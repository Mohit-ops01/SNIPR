# ⚡ SNIPR - AI-Powered URL Shortener
...
```properties
spring.datasource.url=jdbc:postgresql://localhost:5432/SNIPR_db
...
- Mohit Sharma - Final Year Project
